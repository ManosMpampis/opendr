...
class MobileNetV2Small(nn.Module):
    def __init__(
        ...
        self.length_of_interverted_residual = len(self.interverted_residual_setting)
        for i in range(self.length_of_interverted_residual):
    ...
    def build_mobilenet_stage(self, stage_num):
        ...
        if stage_num == (self.length_of_interverted_residual-1):
